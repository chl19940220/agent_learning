...
本节将深入探讨这两个问题，帮你建立"注意力预算"的思维模型，并掌握三种核心的上下文管理技术。这些内容是后续所有实践的理论基础——8.3 节的长时程策略和 8.4 节的 GSSC 流水线，都建立在本节的概念之上。
...
> 💡 **实践建议**：在生产项目中，通常**组合使用**这三种技术：用滑动窗口保留最近对话，用摘要压缩处理更早的历史，用语义过滤从长期记忆中召回相关信息。我们将在 8.4 节的实战中演示这种组合。
...
*下一节：[8.3 长时程任务的上下文策略](./03_long_horizon.md)*
