...
- [第19章 项目实战：AI 编程助手](./chapter_coding_agent/README.md)
  ...
  - [19.2 代码理解与分析能力](./chapter_coding_agent/02_code_understanding.md)
  - [19.3 代码生成与修改能力](./chapter_coding_agent/03_code_generation.md)
  - [19.4 测试生成与 Bug 修复](./chapter_coding_agent/04_testing_debugging.md)
  - [19.5 完整项目实现](./chapter_coding_agent/05_full_implementation.md)

- [第20章 项目实战：智能数据分析 Agent](./chapter_data_agent/README.md)
  - [20.1 需求分析与架构设计](./chapter_data_agent/01_requirements.md)
  - [20.2 数据连接与查询](./chapter_data_agent/02_data_connection.md)
  - [20.3 自动化分析与可视化](./chapter_data_agent/03_analysis_visualization.md)
  - [20.4 报告生成与导出](./chapter_data_agent/04_report_generation.md)
  - [20.5 完整项目实现](./chapter_data_agent/05_full_implementation.md)

- [第21章 项目实战：多模态 Agent](./chapter_multimodal/README.md)
  - [21.1 多模态能力概述](./chapter_multimodal/01_multimodal_overview.md)
  - [21.2 图像理解与生成](./chapter_multimodal/02_image_understanding.md)
  - [21.3 语音交互集成](./chapter_multimodal/03_voice_interaction.md)
  - [21.4 实战：多模态个人助理](./chapter_multimodal/04_practice_multimodal_assistant.md)
