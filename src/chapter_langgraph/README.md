...
> **前置知识**：[第11章 LangChain](../chapter_langchain/README.md)
>
> **后续推荐**：
> - 👉 [第14章 多 Agent 协作](../chapter_multi_agent/README.md) — 用 LangGraph 构建多 Agent 系统
> - 👉 [第19-21章 综合项目](../chapter_coding_agent/README.md) — 在实战项目中综合运用 LangGraph

---

*下一节：[12.1 为什么需要图结构？](./01_why_graph.md)*
