...
- **最优信息输入**：不是"越多越好"，也不是"越少越好"，而是在有限预算内选出**最优子集**。往上下文里塞太多无关信息，反而会降低 LLM 的表现（我们将在 3.2 节详细讨论这个违反直觉的现象）。
...
在后续的 3.2 节中，我们会更详细地讨论 LLM 的注意力分布机制，那时你会从技术层面理解"为什么少反而更好"。
...
*下一节：[3.2 上下文窗口管理与注意力预算](./02_context_window.md)*
