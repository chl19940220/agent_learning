...
这是最直觉的策略——就像整理书桌一样，定期把堆积的文件归档成摘要，腾出空间放新的工作材料。如果你在 3.2 节理解了摘要压缩技术，那么压缩整合可以看作它的"升级版"——不仅仅是压缩单段对话，而是**系统性地管理整个对话历史的生命周期**。
...
*下一节：[3.4 实战：构建上下文管理器](./04_practice_context_builder.md)*
